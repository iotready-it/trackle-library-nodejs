...
export declare enum Ota_Method {
    NO_OTA = 0,
    PUSH = 1,
    SEND_URL = 2
}
...
export declare enum Function_PermissionDef {
    ALL_USERS = 1,
    OWNER_ONLY = 2
}
export declare enum Data_TypeDef {
    VAR_BOOLEAN = 1,
    VAR_INT = 2,
    VAR_STRING = 4,
    VAR_CHAR = 5,
...
export declare enum Event_Flags {
    EMPTY_FLAGS = 0,
    NO_ACK = 2,
    WITH_ACK = 8,
    ALL_FLAGS = 10
...
interface TrackleWrapper {
     ...
     */
    setLogCallback(callback: (msg: string, level: number, category: string, attribute?: Buffer, reserved?: Buffer) => void): void;
    /**
     * Sets the log level.
     ...
     */
    setSendCallback(callback?: (buffer: Buffer, bufferLen: number, tmp: any) => number | Promise<number>): number;
    /**
     ...
     * @returns The result of the operation.
     */
    setConnectCallback(callback?: (address: string, port: number) => number | Promise<number>): number;
    /**
     ...
     */
    setSystemTimeCallback(callback: (time: number, param: number, data?: Buffer) => void): void;
    /**
     ...
     */
    setCompletedPublishCallback(callback: (error: number, callbackData?: number) => void): void;
    /**
     ...
     * @returns A boolean indicating if the operation was successful.
     */
    get(callbackName: string, callback: (arg: string) => any, returnType: Data_TypeDef): boolean;
    /**
